...
class ResetPasswordController extends AbstractController
{
     ...
     */
    #[Route('/verifie-email', name: 'visitor_authentication_check_email')]
     ...
     */
    #[Route('/reinitialiser/{token}', name: 'visitor_authentication_reset_password')]
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer, TranslatorInterface $translator): RedirectResponse
    {
        ...
        $email = (new TemplatedEmail())
            ->from(new Address('quentin.martens@orange.fr', 'Padel Time'))
            ->to($user->getEmail())
            ->subject('Réinitialisation de votre mot de passe sur le site de Padel Time')
