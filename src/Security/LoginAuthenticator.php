...
class LoginAuthenticator extends AbstractLoginFormAuthenticator
{
    ...
    public function authenticate(Request $request): Passport
    {
        ...
        // 4- Vérifier si l'email et le mot de passe provenant du formulaire correspondent à un utilisateur existant en base de donnée
        return new Passport(
            new UserBadge($email),
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, string $firewallName): ?Response
    {
        ...
        // 6- Dans le cas contraire,
            // Rediriger l'admin vers l'espace d'administration
        ...
        {
            return new RedirectResponse($this->urlGenerator->generate('visitor_home_index'));
        }
    }
